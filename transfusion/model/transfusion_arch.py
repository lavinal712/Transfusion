    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            if num_images == 0:
                ...
                new_image_positions.append(torch.zero_like(labels[batch_idx]))
                cur_image_idx += 1
                continue
            ...
            new_image_positions.append(cur_new_image_positions)
        ...
        if tokenizer_model_max_length is not None:
            ...
            new_image_positions = [x[:tokenizer_model_max_length] for x in new_image_positions]
