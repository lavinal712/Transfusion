...
from transfusion.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
from torch.utils.data import Dataset
from transfusion.train.transfusion_trainer import TransfusionTrainer

from transfusion import conversation as conversation_lib
from transfusion.model import *
from transfusion.mm_utils import tokenizer_image_token
...
class ModelArguments:
    ...
    gen_projector_type: Optional[str] = field(default="linear_2")
...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        ...
        model = transformers.TransfusionLlamaForCausalLM.from_pretrained(
            model_args.model_name_or_path,
            cache_dir=training_args.cache_dir,
            attn_implementation=attn_implementation,
            torch_dtype=(torch.bfloat16 if training_args.bf16 else None),
